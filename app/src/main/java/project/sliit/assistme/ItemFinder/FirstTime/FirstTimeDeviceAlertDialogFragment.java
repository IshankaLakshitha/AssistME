...
public class FirstTimeDeviceAlertDialogFragment extends DialogFragment {

    public static final String NAME = "name";
    public static final String ADDRESS = "address";
    public static final String CHECKED = "checked";

    public static FirstTimeDeviceAlertDialogFragment instance(String name, String address, boolean checked)
    {
        FirstTimeDeviceAlertDialogFragment frag = new FirstTimeDeviceAlertDialogFragment();
        ...
        final AlertDialog dialog = new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(android.R.string.ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            {//dopositeive interface that can update name
